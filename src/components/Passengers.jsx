...
const Passengers = ({
    ...
    const passengerTypes = [
        ...
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 48 48"><defs><mask id="IconifyId1990ef51ebc461da05"><g fill="none"><path fill="#fff" fillRule="evenodd" stroke="#fff" strokeWidth="4" d="M24 43.6c8.432 0 15.56-6.68 17.894-14.35C42.418 27.526 46 27.526 46 23.8s-3.616-3.94-4.201-5.752C39.372 10.535 32.32 4 24 4C15.675 4 8.62 10.54 6.197 18.06C5.615 19.87 2 20.01 2 23.8s3.592 3.79 4.135 5.542C8.497 36.964 15.602 43.6 24 43.6Z" clipRule="evenodd"/><path stroke="#fff" strokeLinecap="round" strokeWidth="4" d="M41.799 18.048C39.372 10.535 32.32 4 24 4"/><path fill="#000" stroke="#000" d="M19.1 21.6c0 .826-.224 1.552-.56 2.056c-.339.508-.751.744-1.14.744s-.8-.236-1.14-.744c-.336-.504-.56-1.23-.56-2.056s.224-1.552.56-2.056c.34-.508.752-.744 1.14-.744c.389 0 .801.236 1.14.744c.336.504.56 1.23.56 2.056Zm13.2 0c0 .826-.224 1.552-.56 2.056c-.339.508-.752.744-1.14.744s-.801-.236-1.14-.744c-.336-.504-.56-1.23-.56-2.056s.224-1.552.56-2.056c.339-.508.752-.744 1.14-.744s.801.236 1.14.744c.336.504.56 1.23.56 2.056Z"/><path fill="#000" fillRule="evenodd" d="M18.498 31.75q2.896 1.95 5.511 1.95q2.613 0 5.18-1.945" clipRule="evenodd"/><path stroke="#000" strokeLinecap="round" strokeWidth="4" d="M18.498 31.75q2.896 1.95 5.511 1.95q2.613 0 5.18-1.945"/><path stroke="#fff" strokeLinecap="round" strokeWidth="4" d="M31.728 6.2q.402 2.901-1.769 4.239t-7.055 1.254"/></g></mask></defs><path fill="currentColor" d="M0 0h48v48H0z" mask="url(#IconifyId1990ef51ebc461da05)"/></svg>
            )
        }
    ];
                ...
                <div className="absolute top-full md:-right-8 -right-14 mt-2 bg-white border border-gray-300 rounded-lg shadow-lg p-4 z-50 min-w-64 md:w-[380px] w-[300px]">
                    ...
                    <div className="mt-4 pt-3 border-t border-gray-200">
                        ...
                        <button
                            ...
                            className="w-full py-2 px-4 text-sm font-medium bg-[#364A9C] hover:bg-blue-900 duration-300 text-white rounded-lg transition-colors"
                        >
                            Done
                        </button>
                    </div>
