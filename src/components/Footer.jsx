        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              {/* <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Special Deals</a></li> */}
            </ul>
          </div>
          ...
          <div className="md:text-right text-left">
            ...
            <ul className="space-y-2">
              <li>
                <a 
                  href={`mailto:${contactInfo?.email || 'Melcomtravelandtour@gmail.com'}`} 
                  className="text-gray-400 hover:text-white transition-colors"
                >
                  {contactInfo?.email || 'Melcomtravelandtour@gmail.com'}
                </a>
              </li>
              <li>
                <p className="text-gray-400 hover:text-white transition-colors">
                  {contactInfo?.phone || '+12 345 678 09'}
                </p>
              </li>
              <li>
                <p className="text-gray-400 hover:text-white transition-colors">
                  {contactInfo?.address || contactInfo?.location || 'Accra, Ghana'}
                </p>
              </li>
            </ul> 
          <div>
            <div className="flex justify-end mt-3 gap-4">
                ...
                <a href={contactInfo?.socialMedia?.linkedin || '#'} className="text-gray-400 hover:text-white transition-colors">
