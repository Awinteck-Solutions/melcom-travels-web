  ...
  return (
    <header className="bg-white px-6 py-4">
      <div className="max-w-7xll mx-auto flex items-start justify-between">
        ...
        {/* Navigation */}
        <nav className="md:flex hidden items-center overflow-x-auto scrollbar-thin font-semibold space-x-8 duration-300 transition-all">
          {currentPage === 'flights' ? <a href="/flights" className="flex items-center space-x-2 text-[#364A9C]  border-2 border-[#364A9C] bg-blue-50/50 px-4 py-2 rounded-xl">
            <span>Flights</span>
            ...
            : <a href="/flights" className="text-gray-700 hover:text-[#364A9C] transition-colors">Flights</a>
          }
          ...
          {currentPage === 'contact' ? <a href="/" className="flex items-center space-x-2 text-[#364A9C]  border-2 border-[#364A9C] bg-blue-50/50 px-4 py-2 rounded-xl">
            ...
            : <a href="/" className="text-gray-700 hover:text-[#364A9C] transition-colors">Contact us</a>
          }
        </nav>
