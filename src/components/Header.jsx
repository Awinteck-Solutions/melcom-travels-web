  ...
  return (
    <header className="bg-white px-6 py-4">
      <div className="max-w-7xll mx-auto flex items-start justify-between">
        ...
        {/* Navigation */}
        <nav className="md:flex hidden items-center overflow-x-auto scrollbar-thin font-semiboldl space-x-8 duration-300 transition-all">
          {currentPage === 'flights' ? <a href="/flights" className="flex items-center space-x-2 text-[#364A9C]  border border-[#364A9C] bg-blue-50/50 px-4 py-2 rounded-xl">
            <span>Flights</span>
            ...
            : <a href="/flights" className="flex items-center space-x-2 text-[#364A9C]  border border-white px-4 py-2 rounded-xl">
            <span className='px-3'>Flights</span>
          </a>
          }
          {/* blogs */}
          {currentPage === 'blogs' ? <a href="/blogs" className="flex items-center space-x-2 text-[#364A9C]  border border-[#364A9C] bg-blue-50/50 px-4 py-2 rounded-xl">
            <span>Blogs</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M3 4v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8h-4"/><path d="M3 4h14v14a2 2 0 0 0 2 2v0M13 8H7m6 4H9"/></g></svg>
          </a>
            : <a href="/blogs" className="flex items-center space-x-2 text-[#364A9C]  border border-white px-4 py-2 rounded-xl">
        ...
        <div className="md:flex hidden items-center space-x-4">
          {isAuthenticated ? (
            <div className="flex items-center space-x-3">
              <Link to="/profile" className="text-gray-700 hover:text-[#364A9C] transition-colors">
                Welcome, {user?.name}
              </Link>
              <button
                onClick={logout}
